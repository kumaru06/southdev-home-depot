        ...
        <div class="login-modal-split">
            ...
            <div class="login-modal-form-panel">
                ...
                <div class="login-modal-footer">
                    ...
                    <a href="<?= APP_URL ?>/index.php?url=google-auth" class="btn-google-login" id="loginGoogleBtn">
                        ...
                        <span class="btn-google-label">Continue with Google</span>
                    </a>
                </div>
            </div>
        </div>

        <div class="login-google-handoff" id="loginGoogleHandoff" hidden>
            <div class="login-google-handoff-inner">
                <div class="login-google-handoff-orb" aria-hidden="true">
                ...
                <div class="login-google-handoff-spinner" aria-hidden="true"></div>
                <h3>Continue with Google</h3>
                <p>You&rsquo;ll choose your Google account next</p>
            </div>
        </div>
    </div>
</div>
